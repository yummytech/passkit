...
export declare const DENSITIES: string[];
export declare const PASS_STYLES: string[];
...
export declare const STRUCTURE_FIELDS: string[];
export declare const REQUIRED_IMAGES: string[];
